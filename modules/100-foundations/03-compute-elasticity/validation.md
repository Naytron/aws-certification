# Validation: Compute and Elasticity

**Level:** 100 | **Cost label:** `USES CREDITS` | **SAA-C03:** Design Resilient Architectures; Design High-Performing Architectures; Design Cost-Optimized Architectures
