# Validation: VPC Networking and DNS

**Level:** 100 | **Cost label:** `FREE-PLAN SAFE` | **SAA-C03:** Design Secure Architectures; Design Resilient Architectures; Design High-Performing Architectures
