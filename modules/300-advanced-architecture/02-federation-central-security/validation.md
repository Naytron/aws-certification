# Validation: Federation, Cross-Account Trust, and Central Security

## Artifact completeness

- [ ] Trust graph includes human, workload, vendor, security, and emergency paths.
- [ ] Policy review identifies principal, condition, tag-provenance, and duration risks.
- [ ] Containment distinguishes new-session prevention from existing-session expiry.
- [ ] Runbook preserves logs, KMS access, and chain of custody.
- [ ] Break-glass workflow has independent authentication, alerting, and expiry.
- [ ] ADR assigns central and member-account response authority.
